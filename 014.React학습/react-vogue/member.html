...
<html lang="ko">
    <head>
        ...
        />
        <title>Member | 보그 코리아 (Vogue Korea) 2022</title>
        <!-- 탭메뉴 출력 아이콘 -->
        <link
            rel="shortcut icon"
    ...
    <body>
        ...
        <div id="info" class="bgc">
            <footer class="info ibx">
                ...
                <!-- 3-2. 회사주소 -->
                <address class="addr">
                    WWW.VOGUE.COM Ⓒ CONDÉNAST ASIA PACIFIC. INC. ALL RIGHTS
                    RESERVED. VOGUE.COM KOREA IS OPERATED BY DOOSAN MAGAZINE.
                </address>
                <!-- 3-3. 하단링크 -->
                <ul class="blink">
                    <li>
